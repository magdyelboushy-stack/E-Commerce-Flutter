...
class CartController extends GetxController {
  ...
  void  addToCart(ProductModel product) {
    ...
    // Convert the product model to cartelization with
    final selectedCartItem = convertToCartItem(product, productQuantityInCart.value);

    // check if the product is already in the cart
    int index = cartItems.indexWhere((item) => item.productId == selectedCartItem.productId && item.variationId == selectedCartItem.variationId);

    if(index >= 0){
      // This quantity is already in the cart
    ...
    updateCart();
    TLoaders.customToast(message: 'Your Products has been added to the Cart');
